...
public class NewTest {
	...
	public void setup(){
	 ...
	 @Test ( enabled = false)     // NDN videos have been replaced with Fun Facts
	 ...
	 @Test ( enabled = false)     // NDN videos have been replaced with Fun Facts
	  public void Fun_Facts_Mugshots_Chrome () throws InterruptedException {
		    ...
		    System.setProperty("webdriver.chrome.driver", "C://Users//alytvynenko//Desktop//QA//Selenium//Settings//SeleniumDrivers//chromedriver_win32//chromedriver.exe");
			wd = new ChromeDriver();        
			...
			if(!wd.findElements(By.cssSelector(".slideshow-facts-item__image.unselectDrag")).isEmpty()){
				...
				for (int i = 0; i < 10; i++){
					...
					WebElement button =  wd.findElement(By.cssSelector(".cbola-slideshow-facts__btn.cbola-slideshow-facts__next-btn"));
				   button.click();
				}		
			}else{
			    //DO SOMETHING ELSE AS SUBMIT BUTTON IS NOT THERE
	 ...
	 @Test (priority =1 , enabled = false)     // Politifact membership tracking Google
	 ...
	 @Test (priority =2 , enabled = false)  // Politifact membership tracking 
	 ...
	 @Test  (priority =3 , enabled = false)    // Politifact membership tracking 
	 
	  public void Membership_Tracking_IE () throws InterruptedException {
		    System.out.println("Internet Explorer is selected"); 
		    System.setProperty("webdriver.ie.driver", "C://Users//alytvynenko//Desktop//QA//Selenium//Settings//SeleniumDrivers//IEDriverServer_x64_3.3.0//IEDriverServer.exe");
	 ...
	 @Test  (priority =1 , enabled = false)    // Things-To-Do search 
	 ...
	 @Test  (priority =1 , enabled = false)    // Things-To-Do search 
	  ...
	  public void Things_To_Do_search_FF_Array () throws InterruptedException {
			...
			wd.get("http://tampabay.com/things-to-do/search/?contentType=" +  searchCategories[randomCategory] + "&q=" + anArray[randomType]);
...
//			searchbox.sendKeys(Keys.RETURN);
			...
			System.out.println("Search for returned :'" + searchCategories[randomCategory] +" " + text + "'.");
	 ...
	 @Test  (priority =1 , enabled = false)    // Things-To-Do search 
	  ...
	  public void Things_To_Do_search_FF_events_daterange () throws InterruptedException {
			...
			wd.get("http://www.tampabay.com/things-to-do/search/?contentType=events&q=" + anArray[randomType]+"&"+dateRanges[randomDate]);
...
//			searchbox.sendKeys(Keys.RETURN);
			Thread.sleep(3000);	
			String text = wd.findElement( By.cssSelector(".mark")).getText();
			String selectedDate = wd.findElement( By.cssSelector("ul.editorial > li.active > a")).getAttribute("id");
			System.out.println("Search for returned : '" + text   + " "+  selectedDate +"'.");
	 ...
	 @Test  (priority =2 , enabled = false)    // Things-To-Do search 
	 
	  public void Things_To_Do_search_FF_events_Base () throws InterruptedException {
			...
			wd.get("http://livesite-qa-2.tampabay.com/things-to-do/search/?contentType=events&q=" + anArray[randomType]+"&"+dateRanges[randomDate]);  // creating the string for query 
	 ...
	 @Test (priority =1 , enabled = false)     // TBO Trending_Now tracking Google (right rail)
	  ...
	  public void Trending_Now_TBO_Tracking_FF () throws InterruptedException {
			...
			// Loop
				for (int i = 0; i < 10; i++){
					...
					Trending_Now_TBO_ClickLink(
							wd.findElement(By.xpath("//div[@id='tbo-rightrailcontainer']//div[starts-with(@class,'right-rail-text')][1]/a")));
					Thread.sleep(2000);
					wd.get(baseUrl_1);
					Trending_Now_TBO_ClickLink(wd.findElement(By.xpath("//div[@id='tbo-rightrailcontainer']//div[starts-with(@class,'right-rail-text')][2]/a")));
					Thread.sleep(2000);
					wd.get(baseUrl_1);
					Trending_Now_TBO_ClickLink(wd.findElement(By.xpath("//div[@id='tbo-rightrailcontainer']//div[starts-with(@class,'right-rail-text')][3]/a")));
					Thread.sleep(2000);
					wd.get(baseUrl_1);
					Trending_Now_TBO_ClickLink(wd.findElement(By.xpath("//div[@id='tbo-rightrailcontainer']//div[starts-with(@class,'right-rail-text')][4]/a")));
					Thread.sleep(2000);
					wd.get(baseUrl_1);
					Trending_Now_TBO_ClickLink(wd.findElement(By.xpath("//div[@id='tbo-rightrailcontainer']//div[starts-with(@class,'right-rail-text')][5]/a")));
					Thread.sleep(2000);
				}
	 ...
	 @Test (priority =1 , enabled = false)     // TBO Trending_Now tracking Google footer 
	 
	  public void Trending_Now_TBO_footer_Tracking_FF () throws InterruptedException {
		    System.out.println("FF is selected");
		    System.setProperty("webdriver.gecko.driver", "C://Users//alytvynenko//Desktop//QA//Selenium//Settings//geckodriver-v0.13.0-win64//geckodriver.exe");
			wd = new FirefoxDriver();        
			wd.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
			...
			String url4 = "http://ttt-tbdev.newscyclecloud.com/events-tampa-bay/events-sarah-gerard-to-discuss-sign-sunshine-state-essays-20170427/";
				...
				for (int i = 0; i < 1; i++){
					wd.get(url); 
					WebElement line1 =  wd.findElement(By.xpath("//*[@id='tbo-mostread-container']/div[2]/div[1]/a"));
					...
					wd.get(url1); 
					WebElement line2 = wd.findElement(By.xpath("//*[@id='tbo-mostread-container']/div[2]/div[2]/a"));
					...
					wd.get(url2); 
					WebElement line3 = wd.findElement(By.xpath("//*[@id='tbo-mostread-container']/div[2]/div[3]/a"));
					...
					wd.get(url3); 
					WebElement line4 = wd.findElement(By.xpath("//*[@id='tbo-mostread-container']/div[2]/div[4]/a"));
					...
					wd.get(url4); 
					WebElement line5 = wd.findElement(By.xpath("//*[@id='tbo-mostread-container']/div[2]/div[5]/a"));
	 ...
	 @Test (priority =1 , enabled = false)     // Most_shared_Times tracking Google Analytics 
	  ...
	  public void Most_Shaed_Tracking_FF () throws InterruptedException {
			...
			String url =  "http://livesite-qa-2.tampabay.com/";
				...
				for (int i = 0; i < 22; i++){
					wd.get(url); 
					WebElement line1 =  wd.findElement(By.xpath(".//div[@class='articleList mostEmailed']//h3/a"));
					String string1 = line1.getText();
					line1.click();
					System.out.println("Article name : "+ string1);
	 ...
	 @Test (priority =1 , enabled = false)     // Weather_Times tracking Google Analytics 
	  ...
	  public void Weather_Tracking_FF () throws InterruptedException {
			...
			String url =  "http://ttt-tbdev.newscyclecloud.com/weather/";
				...
				for (int i = 0; i < 10; i++){
					...
					wd.get(url);
					//WebElement line1 =  wd.findElement(By.xpath("//*[@id='tabWeatherHolder']/div/button[1]"));
					
					WebElement line1 =  wd.findElement(By.xpath("//*[@id='tabWeatherHolder']/div[1]/button[2]"));
					String string1 = line1.getText();
					line1.click();
					System.out.println("Tab name is : "+ string1);
					
					WebElement line2 =  wd.findElement(By.xpath(".//*[@id='tabWeatherHolder']/div[1]/button[1]"));
	 ...
	 @Test (priority =1 , enabled = false)     // Politifact load time QA
	  ...
	  public void Politifact_loadTime_QA () throws InterruptedException {
		 System.out.println("Chrome is selected");
		   ...
		   System.out.println("Total Time for page load QA :- "+totalTime+"mls"); 
			
			
	 }
	 
	 @Test  ( enabled = false)   // Test data.  Could be changed
	  public void Fun_Facts2 () throws InterruptedException {
		...
		while (true){
			    ...
			    try {
			      button = wd.findElement(By.cssSelector(".slideshow-facts-item__image.unselectDrag"));
	 ...
	 @Test (priority =1 , enabled = true)     // Politifact load time QA Is not ready. Could be changed 
	  ...
	  public void WordPress_Login () throws InterruptedException {
		 System.out.println("FF is selected");
			...
			boolean elementExists = isElementPresent(wd, By.xpath(".//*[@id='loginbutto']"));
		 ...
		 if (elementExists){
		  ...
		  Thread.sleep(2000);
		  wd.findElement(By.xpath(".//*[@id='user_pass']")).sendKeys("QA_Test_12345");
		  Thread.sleep(2000);
	 ...
	 @Test (priority =1 , enabled = false)     // Politifact load time QA Is not ready. Could be changed 
	 ...
	 @Test (priority =1 , enabled = false)    // Study test
